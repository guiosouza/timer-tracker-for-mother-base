    ...
    return (
      <View style={styles.fieldContainer}>
        ...
        <View style={styles.booleanSelector}>
          <TouchableOpacity 
            style={[styles.booleanOption, value === true && styles.selectedOption]}
            onPress={() => updateTaskField(key, true)}
          >
            <ThemedText style={[styles.booleanText, { color: value === true ? '#fff' : colors.text }]}>true</ThemedText>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.booleanOption, value === false && styles.selectedOption]}
            onPress={() => updateTaskField(key, false)}
          >
            <ThemedText style={[styles.booleanText, { color: value === false ? '#fff' : colors.text }]}>false</ThemedText>
          </TouchableOpacity>
        </View>
      </View>
    );
          ...
          if (key === "timeline") {
            return (
              <View key={key} style={styles.fieldContainer}>
                <ThemedText>{key}: </ThemedText>
                <ThemedText>[{editedTask.timeline.length} registros]</ThemedText>
              </View>
            );
          }
    ...
    >
      <ThemedView style={styles.container}>
        ...
        <View style={styles.modeSelector}>
          <TouchableOpacity 
            style={[styles.modeButton, editMode === "visual" && styles.selectedMode]}
            onPress={() => setEditMode("visual")}
          >
            <ThemedText style={[styles.modeText, { color: editMode === "visual" ? "#fff" : colors.text }]}>Modo Visual</ThemedText>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.modeButton, editMode === "raw" && styles.selectedMode]}
            onPress={() => setEditMode("raw")}
          >
            <ThemedText style={[styles.modeText, { color: editMode === "raw" ? "#fff" : colors.text }]}>Modo JSON</ThemedText>
          </TouchableOpacity>
        </View>
